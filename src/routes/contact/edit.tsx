...
export default function EditContact(): JSX.Element {
  const { model } = useLoaderData() as { model: ContactModel };
    ...
    <Form method="post" id="contact-form" ref={formRef} noValidate>
      ...
      <label>
        ...
        <input placeholder="https://example.com/avatar.jpg"
          ...
          type="text" name="avatar" defaultValue={model.avatar}
        />
      </label>
      <label>
        <span>Notes</span>
        <textarea name="notes" defaultValue={model.notes} rows={6} />
      </label>
      <p>
